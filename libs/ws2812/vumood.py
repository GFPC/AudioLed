...
smoothed_bass_level = 0.7  # Начальное значение для сглаженного уровня басса
...
try:
    ...
    while True:
        ...
        brightness = int(map_value(smoothed_bass_level, 0, 4000000, 0, 255))  # Настройте 5000 под ваш сигнал
